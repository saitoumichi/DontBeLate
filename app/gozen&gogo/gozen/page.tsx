        ...
        <tbody>
          <tr>
            <td className="border-none flex flex-col items-center">
              <h4 
                className={`1gen ${selectedDirection === 'outbound' ? 'selected' : ''} cursor-pointer flex items-center justify-center mt-4 mb-6 rounded-2xl font-bold text-sm w-60 h-12 bg-fuchsia-400`}
